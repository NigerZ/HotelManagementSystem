...
<head>
    ...
    <![endif]-->
    <style>
        body {background-image:url("${pageContext.request.contextPath}/statics/images/bg.jpg");height:100%;width:100%;}
    ...
    <div class="admin-login-background">
        ...
        <form class="layui-form" action="">
            <div>
                ...
                <input type="text" name="username" id="username" placeholder="请输入用户名" autocomplete="off" class="layui-input admin-input admin-input-username">
            </div>
            <div>
